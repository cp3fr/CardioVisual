...
class ModuleMain(DrawableHUDModule):
    ...
    confDescription = [
        ...
        ('keys', 'str', "List of keys to close dialog (space-separated list of keys, e.g. 'A _1 NUM_1 ENTER LEFT')"),
    ]
    ...
    def start(self, dt=0, duration=-1, configName=None):
        ...
        self.dialog = self.dialogs[self.activeConf['text']]
