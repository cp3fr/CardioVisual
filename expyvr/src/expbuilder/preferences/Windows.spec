...
[general]
    ...
    # for the user to add custom components (semi column separated string)
    componentsPath = string(default='$EXPYVRROOT$/lncocomponents/')
...
[keyBindings]
	...
	# Experiment
    testRoutine = string(default='Ctrl+Shift+T')
